...
<body class="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            value="{{ $email }}"
                            readonly
                            class="pl-10 block w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors"
            ...
            @else
            <div class="text-center">
                <p class="text-gray-600 mb-4">Please verify your OTP first.</p>
                <a href="{{ route('password.otp') }}" class="text-red-600 hover:text-red-700 font-medium">
