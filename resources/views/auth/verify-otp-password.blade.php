    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            maxlength="6"
                            pattern="[0-9]{6}"
                            class="pl-10 block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors text-center text-2xl tracking-widest"
                            placeholder="000000"
                        >
                    </div>
            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                <a href="{{ route('password.request') }}" class="w-full flex justify-center py-3 px-4 border-2 border-gray-200 rounded-lg shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-300">
                    Resend OTP
                </a>
            </div>
            ...
            <div class="mt-6">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-white text-gray-500">Changed your mind?</span>
                    </div>
                </div>
