...
<head>
    ...
    <title>Submit Documents - EduAid</title>
...
<body class="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50">
        ...
        <div class="container mx-auto px-4 py-3">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-6">
                    ...
                    <a href="{{ route('student.payout-documents.index') }}" class="text-red-600 font-medium transition-colors text-sm">PAYOUT DOCS</a>
            ...
            <div id="mobileMenu" class="hidden md:hidden mt-4 pb-3 space-y-2">
                ...
                <a href="{{ route('student.payout-documents.index') }}" class="block py-2 text-gray-700 hover:text-red-600 text-sm">PAYOUT DOCS</a>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Submit Documents</h1>
            <p class="text-gray-600 mt-2">Submit your COR, COE, and COG for {{ $payoutEvent->event_name }}</p>
        </div>

        <div class="bg-white shadow rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Payout Event Details</h2>
            </div>
            ...
            <div class="px-6 py-4">
                ...
                <div class="mt-4">
                    ...
                    <p class="text-gray-900">{{ $payoutEvent->description }}</p>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden mt-6">
            ...
            <div class="px-6 py-4">
                <form action="{{ route('student.payout-documents.store', $payoutEvent->event_id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Certificate of Registration (COR)</label>
                            <input type="file" name="cor" required accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            <p class="text-xs text-gray-500 mt-1">PDF, JPG, JPEG, PNG (Max 5MB)</p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Certificate of Enrollment (COE)</label>
                            <input type="file" name="coe" required accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            <p class="text-xs text-gray-500 mt-1">PDF, JPG, JPEG, PNG (Max 5MB)</p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Certificate of Grades (COG)</label>
                            <input type="file" name="cog" required accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            <p class="text-xs text-gray-500 mt-1">PDF, JPG, JPEG, PNG (Max 5MB)</p>
                        </div>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="{{ route('student.payout-documents.index') }}" class="px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
                                Cancel
                            </a>
                        </div>
                    </div>
